...
<!--                    </td>-->
                    <td>
                        ...
                        <ul class = "dropdown-menu" aria-labelledby = "navbarScrollingDropdown">
                            ...
                            <!--                                            </li>-->
                            <li>
                                <router-link :to = "'/panel/user/'+data.id" class = "dropdown-item" style = "text-align: right !important">
                                    مشاهده
                                </router-link>
                                <router-link :to = "'/panel/edit/user/'+data.id" class = "dropdown-item" style = "text-align: right !important">
                                    ویرایش
                                </router-link>
